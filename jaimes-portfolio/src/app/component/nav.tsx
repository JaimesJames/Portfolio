    ...
    return (
        <>
            <div onClick={()=>handleSection} className={`md:flex hidden fixed bottom-14 right-28 z-50 flex-col items-end gap-10 `}>
                ...
                <div className={`hover:rounded-xl cursor-pointer flex items-center justify-center w-16 h-16  ${navState === 'hide' ? 'rotate-0 bg-white' : 'rotate-225  bg-amber-500'} duration-700 ease-in-out`} onClick={() => navState == 'hide' ? setNavState('lock') : setNavState('hide')}>

                    <svg className="stroke-2" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
