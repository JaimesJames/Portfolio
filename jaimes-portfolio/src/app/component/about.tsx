                ...
                <div className="w-full flex md:flex-row flex-col text-center md:text-start gap-10 md:justify-around bg-gray-100 p-20">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-xl">Fast and easy learner<br />
                            ...
                            Adaptability<br />
                            High motivation<br />
                            flexible and under pressure
                        </p>
                    </div>
                    <div className="flex flex-col gap-4">
                        <h1 className="text-2xl font-bold">Programs</h1>
                        <p className="text-xl">Visual Studio Code<br />
                            Docker<br />
                            Maya<br />
                            Unreal Engine<br />
                            Figma<br />
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-2xl font-bold">Languages &<br />
                            Skills</h1>
                        <p className="text-xl">Typescript<br />
                            Javascript<br />
                            Python<br />
                            UI Designing<br />
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-2xl font-bold">Frameworks &<br />
                            Tools</h1>
                        <p className="text-xl">React.js<br />
                            Tailwind CSS<br />
                            Next.js<br />
                            Three.js<br />
                            Express.js<br />
