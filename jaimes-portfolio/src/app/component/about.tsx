                    ...
                    <div className="md:w-10/12 pt-10 h-full">
                        ...
                        <div className=" w-auto h-auto flex md:flex-row justify-center md:justify-start gap-4 mt-20">
                            ...
                            <a href="https://github.com/JaimesJames">
                                <div className="w-14 h-14 bg-amber-500 rounded-full flex justify-center content-center p-2 hover:bg-white">
                            ...
                            <a href="https://www.instagram.com/jaimesjxmes/">
                                <div className="w-14 h-14 bg-amber-500 rounded-full flex justify-center content-center p-3 hover:bg-white">
