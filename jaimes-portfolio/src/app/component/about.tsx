...
const About = (props: AboutData) => {
    ...
    return (
        <>
            <div className="absolute z-0 top-full left-0 w-full h-40 bg-gradient-to-t from-transparent to-black" />
            <div className="mt-56 h-auto text-white observer p-12" data-title="About">
                <div className="mt-10">
                ...
                <div className="p-4 h-auto w-full flex md:flex-row flex-col gap-20 text-center md:text-start content-center justify-center relative">
                    <div className="md:w-10/12 pt-10">
                        ...
                        <div className=" w-auto h-auto flex md:flex-row justify-center md:justify-start gap-4 mt-20">
                            <div className="w-14 h-14 bg-white  rounded-full  flex justify-center content-center p-4">
                            ...
                            <div className="w-14 h-14 bg-white  rounded-full flex justify-center content-center p-2">
                            ...
                            <div className="w-14 h-14 bg-white  rounded-full flex justify-center content-center p-3">
                    ...
                    <div>
                        {props.about.map((e) => {
                            return (
                                    ...
                                    <div className="flex flex-col gap-4 my-5 p-6 shadow-lg shadow-stone-900 rounded-lg">
