...
const Domfinding = () => {
    return (
        <>
            <div className=" p-4 lg:h-500 w-full flex flex-col content-center justify-center relative z-10 md:bg-white rounded-2xl md:text-ci-1 text-white">
                ...
                <div className="md:p-20 p-5  lg:flex-row flex flex-col justify-between content-center text-left">
                    <div>
                        {/* <Image src={mock} width={0} height={0} alt='coral' /> */}
                    </div>
                    <div className="flex flex-col gap-5 content-center justify-center md:p-14">
                        <div>
                            <h1 className="text-4xl font-bold text-center lg:text-start text-purple-500">KMITL with dormitory finding</h1>
                            <h4 className="text-2xl text-center lg:text-start">UX & UI Design Project</h4>
                        </div>
