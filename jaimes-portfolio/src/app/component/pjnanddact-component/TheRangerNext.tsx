...
const TheRangerNext = () => {
    return (
        <>
            <div className=" p-4 md:h-500 w-full flex flex-col content-center justify-center relative z-10 md:bg-ranger rounded-2xl">
                ...
                <div className="md:p-20 p-5 flex md:flex-row flex-col justify-between content-center text-left gap-10">
                    <div>
                        <Image src={mock} width={700} height={100} alt='coral' />
                    </div>
                    <div className="flex flex-col gap-10 content-center justify-center text-white p-2">
                        <div>
                            <h1 className="text-4xl font-bold text-center md:text-start text-FFE55B">IT Ladkrabang Open house 2023 -The Ranger Next</h1>
                            <h4 className="text-2xl text-center md:text-start">Key Conceptual Design</h4>
                        </div>
