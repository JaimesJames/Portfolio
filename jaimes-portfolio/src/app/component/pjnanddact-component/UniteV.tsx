...
const Unite = () => {
    return (
        <>
            <div className=" p-4 lg:h-500 w-full flex flex-col content-center justify-center relative z-10 md:bg-yellow-600 rounded-2xl md:text-ci-1 text-white">
                ...
                <div className="md:p-20 p-5 flex lg:flex-row flex-col-reverse justify-between content-center text-left">
                    ...
                    <div className="flex flex-col gap-10 content-center justify-center md:p-14">
                        ...
                        <div className=" w-auto h-auto flex gap-4 lg:justify-end justify-center">
