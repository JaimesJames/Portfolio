            ...
            <div className=" p-4 h-screen w-full flex flex-col content-center justify-center relative z-10">
                ...
                <div className="p-20 flex justify-between content-center text-left">
                    ...
                    <div className="flex flex-col gap-10 content-center justify-center">
                        <div>
                            <h1 className="text-3xl font-bold">Unite V - Detective City</h1>
                            <h4 className="text-2xl ">Artwork</h4>
                        </div>
                        <p className="text-xl ">I’ve Art Leader Position in Unite 5th.
                            Design Mood board, CI
                            and Another Artworks</p>
                        <div className=" w-auto h-auto flex justify-end gap-4 ">
                            <div className="w-14 h-14 bg-A7271A rounded-full flex justify-center content-center p-3">
