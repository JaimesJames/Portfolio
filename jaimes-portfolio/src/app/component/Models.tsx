                    ...
                    <div className='h-full md:w-1/3 flex flex-col gap-6 content-center justify-center'>
                        ...
                        <div className="p-3 w-auto h-auto flex md:flex-row justify-center md:justify-start gap-4">
                            <a href="https://www.artstation.com/jaimesjames">
                                <div className="w-14 h-14 md:bg-ci-1 bg-amber-500 rounded-full  flex justify-center content-center p-4">
                            ...
                            <a href="https://www.instagram.com/popingalle/">
                                <div className="w-14 h-14 md:bg-ci-1 bg-amber-500 rounded-full flex justify-center content-center p-3">
